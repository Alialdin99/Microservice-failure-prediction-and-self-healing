...
def init_environments():
    ...
    env = DummyVecEnv([lambda: Monitor(MicroserviceEnv())])

    # Create evaluation environment
    eval_env = DummyVecEnv([lambda: Monitor(MicroserviceEnv())])
...
def train_model(env, eval_callback, wandb_callback):
...
def main():
    ...
    env, eval_callback = init_environments()
    train_model(env, eval_callback, wandb_callback)
    wandb.finish()
